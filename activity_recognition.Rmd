...
Since the data discribe the movements of people's body parts, some variations can corelate to others. Let us check this assumption.
...
For this model it is **`r round((1 - err$overall[1])*100, digits=2)`%**.
